...
>
    ...
    <div class="buttons d-flex justify-content-between">
        ...
        <button
            ...
            data-request="<?php echo e($__SELF__.'::onDelete'); ?>"
            data-request-confirm="<?php echo app('translator')->get('igniter.user::default.settings.alert_delete_confirm'); ?>"
        ><?php echo app('translator')->get('igniter.user::default.settings.button_delete'); ?></button>
    </div>
</form>
